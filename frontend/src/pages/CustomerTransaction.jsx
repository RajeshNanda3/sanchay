...
const CustomerTransaction = () => {
  ...
  const applyFilters = (txnList, filter, start, end) => {
    ...
    if (filter === "ISSUE") {
      ...
      filtered = filtered.filter((t) => t.type === "REFERRAL");
    }
      ...
      <div className="max-w-6xl mx-auto">
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">
                        <div>
                          {txn.point_issuance && (
                            <p>
                              Vendor issued {txn.point_issuance.points_issued}{" "}
                              points
                            </p>
                          )}
                          {txn.redemption && (
                            <p>
                              Redeemed {txn.redemption.points_used} points at
                              vendor
                            </p>
                          )}
                          {txn.referral_commission && (
                            <p>
                              Referral commission:{" "}
                              {txn.referral_commission.commission_points} points
                            </p>
                          )}
                          {txn.vendor_transfer && (
                            <p>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <span className="font-semibold">💡 Tip:</span> Use the filters above
            to find specific transactions. Credit (+) means you received points,
            Debit (-) means you spent points.
          </p>
        </div>
      </div>
    </div>
