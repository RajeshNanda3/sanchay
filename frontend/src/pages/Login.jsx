          ...
          >
            ...
            <div className="relative mb-5">
              ...
              <input
                ...
                id="email"
                name="email"
                className="w-full rounded-2xl border border-white/10 bg-[#3e2003] px-4 py-3 text-base text-white outline-none transition focus:border-[#f5d17f] focus:ring-2 focus:ring-[#f5d17f]/20"
                value={email}
